...
describe PatientsController do
  ...
  let(:valid_attributes) { {bed: 'alpha', first_name: 'English', last_name: 'Patient', mrn: '1234'} }
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested patient" do
        ...
        Patient.any_instance.should_receive(:update).with({'bed' => 'beta'})
        put :update, {:id => patient.to_param, :patient => {'bed' => 'beta'}}, valid_session
      end
